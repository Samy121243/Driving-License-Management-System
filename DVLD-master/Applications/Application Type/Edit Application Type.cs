...
namespace DVLD
{
    public partial class Edit_Application_Type : Form
    {
        private int _ApplicationTypeID = -1;
        private clsApplicationType _ApplicationType;

        public Edit_Application_Type(int ApplicationID)
        {
            InitializeComponent();
            _ApplicationTypeID = ApplicationID;
        }

        private void Edit_Application_Type_Load(object sender, EventArgs e)
        {

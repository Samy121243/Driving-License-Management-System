...
namespace DVLD
{
    public partial class frmAdd_UpdateApplication : Form
    {
        ...
        public frmAdd_UpdateApplication()
        {
            InitializeComponent();
            _Mode = enMode.AddNew;
        }

        public frmAdd_UpdateApplication(int LocalDrivingLicenseApplicationID)
        {
            InitializeComponent();
            _Mode = enMode.Update;
        ...
        private void frmAdd_UpdateApplication_Activated(object sender, EventArgs e)
        {
            ctrlPersonCardWithFilter1.FilterFocus();
        }

        private void frmAdd_UpdateApplication_Load(object sender, EventArgs e)
        {
            _ResetDefualtValues();
        ...
        private void btnApplicationInfoNext_Click_1(object sender, EventArgs e)
        {
            if (_Mode == enMode.Update)
            {
                btnSave.Enabled = true;

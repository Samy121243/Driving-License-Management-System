...
namespace DVLD.Applications.International_License
{
    public partial class frmInternationalLicenseList : Form
    {
        ...
        {
            dgvInternationalLicenses.DefaultCellStyle.Font = new Font("Arial", 11);
            dgvInternationalLicenses.ColumnHeadersDefaultCellStyle.Font = new Font("Arial", 12, FontStyle.Bold);
        ...
        private void showDetailsToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            internationalDeriverInfo frm = new internationalDeriverInfo(InternationalLicenseID);
            frm.ShowDialog();
        }

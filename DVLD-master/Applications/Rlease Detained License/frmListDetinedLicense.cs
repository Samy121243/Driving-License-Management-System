...
{
    public partial class frmListDetinedLicense : Form
    {
        private DataTable _dtDetainedLicenses;
        public frmListDetinedLicense()
        {
            InitializeComponent();
        }

        private void frmListDetinedLicense_Load(object sender, EventArgs e)
        {
            dgvDetainedLicenses.DefaultCellStyle.Font = new Font("Arial", 11);
            dgvDetainedLicenses.ColumnHeadersDefaultCellStyle.Font = new Font("Arial", 12, FontStyle.Bold);
        ...
        private void releaseDetainedLicenseToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            frmRelaseDetaindLicenseApplication frm = new frmRelaseDetaindLicenseApplication(LicenseID);
            frm.ShowDialog();
            frmListDetinedLicense_Load(null, null);
        }
